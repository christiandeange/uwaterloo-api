...
public abstract class TransactionDate
    ...
    private static final DateFormat FORMAT_PARSE = new SimpleDateFormat("MM/dd/yyyy hh:mm:ss a", Locale.CANADA);
    private static final DateFormat FORMAT_PRINT = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss", Locale.CANADA);
