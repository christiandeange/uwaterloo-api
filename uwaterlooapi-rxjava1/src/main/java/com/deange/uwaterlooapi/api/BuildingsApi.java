...
public interface BuildingsApi {
  ...
  Observable<Responses.Buildings> getBuildings();
  ...
  Observable<Responses.BuildingEntity> getBuilding(@Path("building_code") String buildingCode);
  ...
  Observable<Responses.RoomCourses> getClassroomCourses(
