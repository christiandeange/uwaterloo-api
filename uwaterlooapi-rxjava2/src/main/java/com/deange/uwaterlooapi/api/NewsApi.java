...
public interface NewsApi {
   ...
   */
  @GET("news.json")
  Observable<Responses.News> getNews();
   ...
   */
  @GET("news/{site}.json")
  Observable<Responses.News> getNews(@Path("site") String site);
  ...
  Observable<Responses.NewsEntity> getNews(@Path("site") String site, @Path("id") int id);
