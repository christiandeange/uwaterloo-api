...
public class AutoScaleTextView extends TextFontView {
    ...
    public AutoScaleTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (a != null) {
            ...
            mMinTextSize = a.getDimensionPixelSize(R.styleable.AutoScaleTextView_minTextSize, DEFAULT_MIN_TEXT_SIZE);
            mMaxTextSize = a.getDimensionPixelSize(R.styleable.AutoScaleTextView_maxTextSize, DEFAULT_MAX_TEXT_SIZE);
